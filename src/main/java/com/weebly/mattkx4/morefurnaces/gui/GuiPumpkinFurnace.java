...
public class GuiPumpkinFurnace extends GuiContainer {
	...
	public GuiPumpkinFurnace(InventoryPlayer inventoryPlayer,
	...
	public void drawGuiContainerForegroundLayer(int i, int j) {
		...
		String name = this.pumpkinFurnace.hasCustomInventoryName() ? this.pumpkinFurnace
				.getInventoryName() : I18n.format(
				this.pumpkinFurnace.getInventoryName(), new Object[0]);
	...
	protected void drawGuiContainerBackgroundLayer(float i, int j, int k) {
		...
		if (this.pumpkinFurnace.isBurning()) {
			...
			int l = 14 - m;
			drawTexturedModalRect(guiLeft + 57, guiTop + 36 + l, 176, 143 + l,
					14, 14 - l);
		}
