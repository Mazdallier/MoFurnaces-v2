...
public class GuiObsidianFurnaceT2 extends GuiContainer {
	...
	public GuiObsidianFurnaceT2(InventoryPlayer inventoryPlayer,
	...
	public void drawGuiContainerForegroundLayer(int i, int j) {
		...
		String name = this.obsidianFurnaceT2.hasCustomInventoryName() ? this.obsidianFurnaceT2
				.getInventoryName() : I18n.format(
				this.obsidianFurnaceT2.getInventoryName(), new Object[0]);
	...
	protected void drawGuiContainerBackgroundLayer(float i, int j, int k) {
		...
		if (this.obsidianFurnaceT2.isBurning()) {
			...
			int l = 14 - m;
			drawTexturedModalRect(guiLeft + 38, guiTop + 36 + l, 176, 59 + l,
					14, 14 - l);
		}
