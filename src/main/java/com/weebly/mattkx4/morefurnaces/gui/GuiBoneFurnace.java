...
public class GuiBoneFurnace extends GuiContainer {
	public static final ResourceLocation bground = new ResourceLocation(
			Strings.MODID + ":textures/gui/bone_furnace.png");

	public TileEntityBoneFurnace boneFurnace;

	public GuiBoneFurnace(InventoryPlayer inventoryPlayer,
	...
	protected void drawGuiContainerForegroundLayer(int p_146979_1_,
			int p_146979_2_) {
		String s = this.boneFurnace.hasCustomInventoryName() ? this.boneFurnace
