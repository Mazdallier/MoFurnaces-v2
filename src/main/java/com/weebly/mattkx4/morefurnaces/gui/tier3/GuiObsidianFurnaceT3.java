...
public class GuiObsidianFurnaceT3 extends GuiContainer {
	...
	public GuiObsidianFurnaceT3(InventoryPlayer inventoryPlayer,
	...
	public void drawGuiContainerForegroundLayer(int i, int j) {
		...
		String name = this.obsidianFurnaceT3.hasCustomInventoryName() ? this.obsidianFurnaceT3
				.getInventoryName() : I18n.format(
				this.obsidianFurnaceT3.getInventoryName(), new Object[0]);
