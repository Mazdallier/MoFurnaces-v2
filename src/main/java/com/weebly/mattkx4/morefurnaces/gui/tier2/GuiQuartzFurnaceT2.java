...
public class GuiQuartzFurnaceT2 extends GuiContainer {
	...
	public GuiQuartzFurnaceT2(InventoryPlayer inventoryPlayer,
	...
	public void drawGuiContainerForegroundLayer(int i, int j) {
		...
		String name = this.quartzFurnaceT2.hasCustomInventoryName() ? this.quartzFurnaceT2
				.getInventoryName() : I18n.format(
				this.quartzFurnaceT2.getInventoryName(), new Object[0]);
