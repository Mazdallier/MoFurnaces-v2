...
import com.weebly.mattkx4.morefurnaces.particles.EntityDiamondFlameFX;
...
public class DiamondFurnaceT2 extends BlockContainer {
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		...
		this.iconFront = iconRegister.registerIcon(Strings.MODID
				+ ":"
				+ (this.isActive ? "DiamondFurnaceT2_front_active"
						: "DiamondFurnaceT2_front_idle"));
	...
	public boolean onBlockActivated(World world, int x, int y, int z,
		...
		if (player.getCurrentEquippedItem() != null) {
			if (player.getCurrentEquippedItem().getItem() == MFMItems.Tier3Device) {
				...
				TileEntityDiamondFurnaceT2 tileentity = (TileEntityDiamondFurnaceT2) world
						.getTileEntity(x, y, z);
				...
				TileEntityDiamondFurnaceT3 tileentityT3 = (TileEntityDiamondFurnaceT3) world
						.getTileEntity(x, y, z);
				if (input1 != null) {
		...
		if (!world.isRemote) {
			FMLNetworkHandler.openGui(player, MoFurnacesMod.instance,
					MoFurnacesMod.guiIDDiamondFurnaceT2, world, x, y, z);
		}
		return true;
	}

	public static void updateDiamondFurnaceT2State(boolean active,
		...
		if (active == true) {
			worldObj.setBlock(xCoord, yCoord, zCoord,
					MFMT2Blocks.DiamondFurnaceT2Active);
		} else {
			worldObj.setBlock(xCoord, yCoord, zCoord,
					MFMT2Blocks.DiamondFurnaceT2Idle);
		}
		keepInventory = false;
	...
	public void onBlockPlacedBy(World world, int x, int y, int z,
		...
		if (itemstack.hasDisplayName()) {
			((TileEntityDiamondFurnaceT2) world.getTileEntity(x, y, z))
		...
		if (this.isActive) {
			...
			if (direction == 4) {
				...
				Minecraft.getMinecraft().effectRenderer
						.addEffect(new EntityDiamondFlameFX(world,
