...
public class ObsidianFurnaceT3 extends BlockContainer {
	...
	public Item getItemDropped(int i, Random random, int j) {
		return Item.getItemFromBlock(MFMT3Blocks.ObsidianFurnaceT3Idle);
	}
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		...
		this.iconFront = iconRegister.registerIcon(Strings.MODID
				+ ":"
				+ (this.isActive ? "ObsidianFurnaceT3_front_active"
						: "ObsidianFurnaceT3_front_idle"));
	...
	public boolean onBlockActivated(World world, int x, int y, int z,
		...
		if (!world.isRemote) {
			FMLNetworkHandler.openGui(player, MoFurnacesMod.instance,
					MoFurnacesMod.guiIDObsidianFurnaceT3, world, x, y, z);
		}
		return true;
	}

	public static void updateObsidianFurnaceT3State(boolean active,
		...
		if (active == true) {
			worldObj.setBlock(xCoord, yCoord, zCoord,
					MFMT3Blocks.ObsidianFurnaceT3Active);
		} else {
			worldObj.setBlock(xCoord, yCoord, zCoord,
					MFMT3Blocks.ObsidianFurnaceT3Idle);
		}
		keepInventory = false;
	...
	public void breakBlock(World world, int x, int y, int z, Block oldblock,
			int oldmetadata) {
		if (!keepInventory) {
			TileEntityObsidianFurnaceT3 tileentity = (TileEntityObsidianFurnaceT3) world
					.getTileEntity(x, y, z);
