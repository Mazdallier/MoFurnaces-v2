...
public class DiamondFurnaceT3 extends BlockContainer {
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		...
		this.iconFront = iconRegister.registerIcon(Strings.MODID
				+ ":"
				+ (this.isActive ? "DiamondFurnaceT3_front_active"
						: "DiamondFurnaceT3_front_idle"));
	...
	public boolean onBlockActivated(World world, int x, int y, int z,
		...
		if (!world.isRemote) {
			FMLNetworkHandler.openGui(player, MoFurnacesMod.instance,
					MoFurnacesMod.guiIDDiamondFurnaceT3, world, x, y, z);
		}
		return true;
	}

	public static void updateDiamondFurnaceT3State(boolean active,
		...
		if (active == true) {
			worldObj.setBlock(xCoord, yCoord, zCoord,
					MFMT3Blocks.DiamondFurnaceT3Active);
		} else {
			worldObj.setBlock(xCoord, yCoord, zCoord,
					MFMT3Blocks.DiamondFurnaceT3Idle);
		}
		keepInventory = false;
	...
	public void onBlockPlacedBy(World world, int x, int y, int z,
		...
		if (itemstack.hasDisplayName()) {
			((TileEntityObsidianFurnaceT3) world.getTileEntity(x, y, z))
	...
	public void breakBlock(World world, int x, int y, int z, Block oldblock,
			int oldmetadata) {
		if (!keepInventory) {
			TileEntityDiamondFurnaceT3 tileentity = (TileEntityDiamondFurnaceT3) world
					.getTileEntity(x, y, z);
