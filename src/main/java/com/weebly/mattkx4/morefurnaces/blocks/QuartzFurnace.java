...
public class QuartzFurnace extends BlockContainer {
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		...
		this.iconFront = iconRegister.registerIcon(Strings.MODID
				+ ":"
				+ (this.isActive ? "QuartzFurnace_front_active"
						: "QuartzFurnace_front_idle"));
	...
	public boolean onBlockActivated(World world, int x, int y, int z,
		...
		if (player.getCurrentEquippedItem() != null) {
			if (player.getCurrentEquippedItem().getItem() == MFMItems.Tier2Device) {
				...
				TileEntityQuartzFurnace tileentity = (TileEntityQuartzFurnace) world
						.getTileEntity(x, y, z);
				ItemStack input;
				ItemStack fuel;
				ItemStack product;
		...
		if (!world.isRemote) {
			FMLNetworkHandler.openGui(player, MoFurnacesMod.instance,
					MoFurnacesMod.guiIDQuartzFurnace, world, x, y, z);
		}
		return true;
	}

	public static void updateQuartzFurnaceState(boolean active, World worldObj,
		...
		if (active == true) {
			worldObj.setBlock(xCoord, yCoord, zCoord,
					MFMBlocks.QuartzFurnaceActive);
		} else {
			worldObj.setBlock(xCoord, yCoord, zCoord,
					MFMBlocks.QuartzFurnaceIdle);
		}
		keepInventory = false;
	...
	public void onBlockPlacedBy(World world, int x, int y, int z,
		...
		if (itemstack.hasDisplayName()) {
			((TileEntityQuartzFurnace) world.getTileEntity(x, y, z))
