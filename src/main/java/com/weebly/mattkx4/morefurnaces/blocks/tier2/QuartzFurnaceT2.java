...
public class QuartzFurnaceT2 extends BlockContainer {
	...
	public QuartzFurnaceT2(boolean isActive) {
		super(Material.rock);
	...
	public Item getItemDropped(int i, Random random, int j) {
		return Item.getItemFromBlock(MFMT2Blocks.QuartzFurnaceT2Idle);
	}
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		...
		this.iconFront = iconRegister.registerIcon(Strings.MODID
				+ ":"
				+ (this.isActive ? "QuartzFurnaceT2_front_active"
						: "QuartzFurnaceT2_front_idle"));
	...
	public boolean onBlockActivated(World world, int x, int y, int z,
		...
		if (player.getCurrentEquippedItem() != null) {
			if (player.getCurrentEquippedItem().getItem() == MFMItems.Tier3Device) {
				...
				TileEntityQuartzFurnaceT2 tileentity = (TileEntityQuartzFurnaceT2) world
						.getTileEntity(x, y, z);
				...
				TileEntityQuartzFurnaceT3 tileentityT3 = (TileEntityQuartzFurnaceT3) world
						.getTileEntity(x, y, z);
				if (input1 != null) {
		...
		if (!world.isRemote) {
			FMLNetworkHandler.openGui(player, MoFurnacesMod.instance,
					MoFurnacesMod.guiIDQuartzFurnaceT2, world, x, y, z);
		}
		return true;
	}

	public static void updateQuartzFurnaceT2State(boolean active,
		...
		if (active == true) {
			worldObj.setBlock(xCoord, yCoord, zCoord,
					MFMT2Blocks.QuartzFurnaceT2Active);
		} else {
			worldObj.setBlock(xCoord, yCoord, zCoord,
					MFMT2Blocks.QuartzFurnaceT2Idle);
		}
		keepInventory = false;
	...
	public TileEntity createNewTileEntity(World world, int i) {
		return new TileEntityQuartzFurnaceT2();
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z,
		...
		if (itemstack.hasDisplayName()) {
			((TileEntityQuartzFurnaceT2) world.getTileEntity(x, y, z))
