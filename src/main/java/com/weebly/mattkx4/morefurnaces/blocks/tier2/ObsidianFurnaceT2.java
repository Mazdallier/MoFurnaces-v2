...
import com.weebly.mattkx4.morefurnaces.blocks.tier3.ObsidianFurnaceT3;
...
import com.weebly.mattkx4.morefurnaces.particles.EntityObsidianFlameFX;
...
public class ObsidianFurnaceT2 extends BlockContainer {
	...
	public Item getItemDropped(int i, Random random, int j) {
		return Item.getItemFromBlock(MFMT2Blocks.ObsidianFurnaceT2Idle);
	}
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		...
		this.iconFront = iconRegister.registerIcon(Strings.MODID
				+ ":"
				+ (this.isActive ? "ObsidianFurnaceT2_front_active"
						: "ObsidianFurnaceT2_front_idle"));
	...
	public boolean onBlockActivated(World world, int x, int y, int z,
		...
		if (player.getCurrentEquippedItem() != null) {
			if (player.getCurrentEquippedItem().getItem() == MFMItems.Tier3Device) {
				...
				TileEntityObsidianFurnaceT2 tileentity = (TileEntityObsidianFurnaceT2) world
						.getTileEntity(x, y, z);
		...
		if (!world.isRemote) {
			FMLNetworkHandler.openGui(player, MoFurnacesMod.instance,
					MoFurnacesMod.guiIDObsidianFurnaceT2, world, x, y, z);
		}
		return true;
	}

	public static void updateObsidianFurnaceT2State(boolean active,
		...
		if (active == true) {
			worldObj.setBlock(xCoord, yCoord, zCoord,
					MFMT2Blocks.ObsidianFurnaceT2Active);
		} else {
			worldObj.setBlock(xCoord, yCoord, zCoord,
					MFMT2Blocks.ObsidianFurnaceT2Idle);
		}
		keepInventory = false;
	...
	public void onBlockPlacedBy(World world, int x, int y, int z,
		...
		if (itemstack.hasDisplayName()) {
			((TileEntityObsidianFurnaceT2) world.getTileEntity(x, y, z))
