...
public class BoneFurnace extends BlockContainer {
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		...
		this.iconFront = iconRegister.registerIcon(Strings.MODID
				+ ":"
				+ (this.isActive ? "BoneFurnace_front_active"
						: "BoneFurnace_front_idle"));
	...
	public boolean onBlockActivated(World world, int x, int y, int z,
		...
		if (!world.isRemote) {
			FMLNetworkHandler.openGui(player, MoFurnacesMod.instance,
					MoFurnacesMod.guiIDBoneFurnace, world, x, y, z);
		}
		return true;
	}

	public static void updateBoneFurnaceState(boolean active, World worldObj,
	...
	public void breakBlock(World world, int x, int y, int z, Block oldblock,
			int oldmetadata) {
		if (!keepInventory) {
			TileEntityBoneFurnace tileentity = (TileEntityBoneFurnace) world
					.getTileEntity(x, y, z);
