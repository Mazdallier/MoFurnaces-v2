...
public class DiamondFurnace extends BlockContainer {
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		...
		this.iconFront = iconRegister.registerIcon(Strings.MODID
				+ ":"
				+ (this.isActive ? "DiamondFurnace_front_active"
						: "DiamondFurnace_front_idle"));
	...
	public boolean onBlockActivated(World world, int x, int y, int z,
		...
		if (player.getCurrentEquippedItem() != null) {
			if (player.getCurrentEquippedItem().getItem() == MFMItems.Tier2Device) {
				...
				TileEntityDiamondFurnace tileentity = (TileEntityDiamondFurnace) world
						.getTileEntity(x, y, z);
				ItemStack input;
				ItemStack fuel;
				ItemStack product;
		...
		if (!world.isRemote) {
			FMLNetworkHandler.openGui(player, MoFurnacesMod.instance,
					MoFurnacesMod.guiIDDiamondFurnace, world, x, y, z);
		}
		return true;
	}

	public static void updateDiamondFurnaceState(boolean active,
		...
		if (active == true) {
			worldObj.setBlock(xCoord, yCoord, zCoord,
					MFMBlocks.DiamondFurnaceActive);
		} else {
			worldObj.setBlock(xCoord, yCoord, zCoord,
					MFMBlocks.DiamondFurnaceIdle);
		}
		keepInventory = false;
	...
	public void onBlockPlacedBy(World world, int x, int y, int z,
		...
		if (itemstack.hasDisplayName()) {
			((TileEntityDiamondFurnace) world.getTileEntity(x, y, z))
