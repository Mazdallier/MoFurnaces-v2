...
public class ContainerDiamondFurnaceT3 extends Container {
	 ...
	 */
	public ContainerDiamondFurnaceT3(InventoryPlayer inventory,
			TileEntityDiamondFurnaceT3 tileentity) {
	...
	public void addCraftingToCrafters(ICrafting icrafting) {
		...
		icrafting.sendProgressBarUpdate(this, 0,
				this.diamondFurnaceT3.cookTime1);
		icrafting.sendProgressBarUpdate(this, 1,
				this.diamondFurnaceT3.cookTime2);
		icrafting.sendProgressBarUpdate(this, 2,
				this.diamondFurnaceT3.cookTime3);
		icrafting
				.sendProgressBarUpdate(this, 3, this.diamondFurnaceT3.burnTime);
		icrafting.sendProgressBarUpdate(this, 4,
				this.diamondFurnaceT3.currentItemBurnTime);
	}
		...
		for (int i = 0; i < this.crafters.size(); i++) {
			...
			if (this.lastBurnTime != this.diamondFurnaceT3.burnTime) {
				icrafting.sendProgressBarUpdate(this, 3,
						this.diamondFurnaceT3.burnTime);
			}
