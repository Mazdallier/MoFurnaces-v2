...
public class ContainerBrickFurnaceT3 extends Container {
	 ...
	 */
	public ContainerBrickFurnaceT3(InventoryPlayer inventory,
			TileEntityBrickFurnaceT3 tileentity) {
	...
	public void addCraftingToCrafters(ICrafting icrafting) {
		...
		icrafting.sendProgressBarUpdate(this, 4,
				this.brickFurnaceT3.currentItemBurnTime);
	}
