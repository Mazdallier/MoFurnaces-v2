package com.weebly.mattkx4.morefurnaces.container.tier3;
...
public class ContainerQuartzFurnaceT3 extends Container {
	 ...
	 */
	public ContainerQuartzFurnaceT3(InventoryPlayer inventory,
			TileEntityQuartzFurnaceT3 tileentity) {
	...
	public void addCraftingToCrafters(ICrafting icrafting) {
		...
		icrafting
				.sendProgressBarUpdate(this, 0, this.quartzFurnaceT3.cookTime1);
		icrafting
				.sendProgressBarUpdate(this, 1, this.quartzFurnaceT3.cookTime2);
		icrafting
				.sendProgressBarUpdate(this, 2, this.quartzFurnaceT3.cookTime3);
		icrafting.sendProgressBarUpdate(this, 3, this.quartzFurnaceT3.burnTime);
		icrafting.sendProgressBarUpdate(this, 4,
				this.quartzFurnaceT3.currentItemBurnTime);
	}
