...
public class ContainerDiamondFurnaceT2 extends Container {
	 ...
	 */
	public ContainerDiamondFurnaceT2(InventoryPlayer inventory,
			TileEntityDiamondFurnaceT2 tileentity) {
	...
	public void addCraftingToCrafters(ICrafting icrafting) {
		...
		icrafting.sendProgressBarUpdate(this, 0,
				this.diamondFurnaceT2.cookTime1);
		icrafting.sendProgressBarUpdate(this, 3,
				this.diamondFurnaceT2.cookTime2);
		icrafting
				.sendProgressBarUpdate(this, 1, this.diamondFurnaceT2.burnTime);
		icrafting.sendProgressBarUpdate(this, 2,
				this.diamondFurnaceT2.currentItemBurnTime);
	}
		...
		for (int i = 0; i < this.crafters.size(); i++) {
			...
			if (this.lastBurnTime != this.diamondFurnaceT2.burnTime) {
				icrafting.sendProgressBarUpdate(this, 1,
						this.diamondFurnaceT2.burnTime);
			}
