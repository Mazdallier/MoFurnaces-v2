...
public class ContainerSteelFurnaceT3 extends Container {
	private TileEntitySteelFurnaceT3 steelFurnaceT3;
	 ...
	 */
	public ContainerSteelFurnaceT3(InventoryPlayer inventory,
			TileEntitySteelFurnaceT3 tileentity) {
		this.steelFurnaceT3 = tileentity;
	...
	public void addCraftingToCrafters(ICrafting icrafting) {
		...
		icrafting.sendProgressBarUpdate(this, 0, this.steelFurnaceT3.cookTime1);
		icrafting.sendProgressBarUpdate(this, 1, this.steelFurnaceT3.cookTime2);
		icrafting.sendProgressBarUpdate(this, 2, this.steelFurnaceT3.cookTime3);
		icrafting.sendProgressBarUpdate(this, 3, this.steelFurnaceT3.burnTime);
		icrafting.sendProgressBarUpdate(this, 4,
				this.steelFurnaceT3.currentItemBurnTime);
	}
	...
	public void detectAndSendChanges() {
		...
		for (int i = 0; i < this.crafters.size(); i++) {
			...
			if (this.lastCookTime1 != this.steelFurnaceT3.cookTime1) {
				icrafting.sendProgressBarUpdate(this, 0,
						this.steelFurnaceT3.cookTime1);
			}

			if (this.lastCookTime2 != this.steelFurnaceT3.cookTime2) {
				icrafting.sendProgressBarUpdate(this, 1,
						this.steelFurnaceT3.cookTime2);
			}

			if (this.lastCookTime3 != this.steelFurnaceT3.cookTime3) {
				icrafting.sendProgressBarUpdate(this, 2,
						this.steelFurnaceT3.cookTime3);
			}

			if (this.lastBurnTime != this.steelFurnaceT3.burnTime) {
				icrafting.sendProgressBarUpdate(this, 3,
						this.steelFurnaceT3.burnTime);
			}

			if (this.lastCurrentItemBurnTime != this.steelFurnaceT3.currentItemBurnTime) {
				icrafting.sendProgressBarUpdate(this, 4,
						this.steelFurnaceT3.currentItemBurnTime);
			}
		}

		this.lastCookTime1 = this.steelFurnaceT3.cookTime1;
		this.lastCookTime2 = this.steelFurnaceT3.cookTime2;
		this.lastCookTime3 = this.steelFurnaceT3.cookTime3;
		this.lastBurnTime = this.steelFurnaceT3.burnTime;
		this.lastCurrentItemBurnTime = this.steelFurnaceT3.currentItemBurnTime;
	}
	...
	public void updateProgressBar(int par1, int par2) {
		if (par1 == 0) {
			this.steelFurnaceT3.cookTime1 = par2;
		}

		if (par1 == 1) {
			this.steelFurnaceT3.cookTime2 = par2;
		}

		if (par1 == 2) {
			this.steelFurnaceT3.cookTime3 = par2;
		}

		if (par1 == 3) {
			this.steelFurnaceT3.burnTime = par2;
		}

		if (par1 == 4) {
			this.steelFurnaceT3.currentItemBurnTime = par2;
		}
	}
	...
	public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer,
		...
		if (slot != null && slot.getHasStack()) {
			...
			if (slots == 4 || slots == 5 || slots == 6) {
				...
				} else if (TileEntitySteelFurnaceT3.isItemFuel(itemstack1)) {
