...
public class ContainerQuartzFurnaceT2 extends Container {
	 ...
	 */
	public ContainerQuartzFurnaceT2(InventoryPlayer inventory,
			TileEntityQuartzFurnaceT2 tileentity) {
	...
	public void addCraftingToCrafters(ICrafting icrafting) {
		...
		icrafting
				.sendProgressBarUpdate(this, 0, this.quartzFurnaceT2.cookTime1);
		icrafting
				.sendProgressBarUpdate(this, 3, this.quartzFurnaceT2.cookTime2);
		icrafting.sendProgressBarUpdate(this, 1, this.quartzFurnaceT2.burnTime);
		icrafting.sendProgressBarUpdate(this, 2,
				this.quartzFurnaceT2.currentItemBurnTime);
	}
