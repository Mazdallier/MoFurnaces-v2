...
public class ContainerDiamondFurnace extends Container {
	 ...
	 */
	public ContainerDiamondFurnace(InventoryPlayer inventory,
			TileEntityDiamondFurnace tileentity) {
	...
	public void addCraftingToCrafters(ICrafting icrafting) {
		...
		icrafting.sendProgressBarUpdate(this, 2,
				this.diamondFurnace.currentItemBurnTime);
	}
		...
		for (int i = 0; i < this.crafters.size(); i++) {
			...
			if (this.lastCookTime != this.diamondFurnace.cookTime) {
				icrafting.sendProgressBarUpdate(this, 0,
						this.diamondFurnace.cookTime);
			}

			if (this.lastBurnTime != this.diamondFurnace.burnTime) {
				icrafting.sendProgressBarUpdate(this, 1,
						this.diamondFurnace.burnTime);
			}
