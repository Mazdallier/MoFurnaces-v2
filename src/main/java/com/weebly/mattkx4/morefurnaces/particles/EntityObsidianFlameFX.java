package com.weebly.mattkx4.morefurnaces.particles;
...
public class EntityObsidianFlameFX extends EntityFlameFX {

	public static final ResourceLocation flame = new ResourceLocation(
			Strings.MODID + ":textures/particles/custom_flames.png");

	/** the scale of the flame FX */
	private float flameScale;
	private static final String __OBFID = "CL_00000907";

	public EntityObsidianFlameFX(World p_i1209_1_, double p_i1209_2_,
		...
		double d6 = p_i1209_2_
				+ (double) ((this.rand.nextFloat() - this.rand.nextFloat()) * 0.05F);
		d6 = p_i1209_4_
				+ (double) ((this.rand.nextFloat() - this.rand.nextFloat()) * 0.05F);
		d6 = p_i1209_6_
				+ (double) ((this.rand.nextFloat() - this.rand.nextFloat()) * 0.05F);
	...
	public int getBrightnessForRender(float p_70070_1_) {
		float f1 = ((float) this.particleAge + p_70070_1_)
	...
	public float getBrightness(float p_70013_1_) {
		float f1 = ((float) this.particleAge + p_70013_1_)
				/ (float) this.particleMaxAge;
