...
import com.weebly.mattkx4.morefurnaces.blocks.QuartzFurnace;
...
public class TileEntityQuartzFurnace extends TileEntity implements
		ISidedInventory {
	...
	public void updateEntity() {
		...
		if (!this.worldObj.isRemote) {
			...
			if (flag != this.isBurning()) {
				flag1 = true;
				QuartzFurnace.updateQuartzFurnaceState(this.burnTime > 0,
