...
import com.weebly.mattkx4.morefurnaces.blocks.tier2.ObsidianFurnaceT2;
...
public class TileEntityObsidianFurnaceT2 extends TileEntity implements
		ISidedInventory {
	...
	public void updateEntity() {
		...
		if (!this.worldObj.isRemote) {
			...
			if (flag != this.isBurning()) {
				flag1 = true;
				ObsidianFurnaceT2.updateObsidianFurnaceT2State(
