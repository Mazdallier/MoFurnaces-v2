...
import com.weebly.mattkx4.morefurnaces.blocks.tier2.SteelFurnaceT2;
...
public class TileEntitySteelFurnaceT2 extends TileEntity implements
		ISidedInventory {
	...
	public int getCookProgressScaled1(int i) {
		return this.cookTime1 * i / FurnaceVariables.STEEL_FURNACE_T2_SPEED;
	}

	// Gets the cooking progress (Scaled) for item 2
	@SideOnly(Side.CLIENT)
	public int getCookProgressScaled2(int i) {
		return this.cookTime2 * i / FurnaceVariables.STEEL_FURNACE_T2_SPEED;
	}
	...
	public int getBurnTimeRemainingScaled(int i) {
		...
		if (this.currentItemBurnTime == 0) {
			this.currentItemBurnTime = FurnaceVariables.STEEL_FURNACE_T2_SPEED;
		}
	...
	public void updateEntity() {
		...
		if (!this.worldObj.isRemote) {
			...
			if ((this.burnTime == 0 && this.canSmelt1())
				...
				// lasting furnace
				this.currentItemBurnTime = this.burnTime = (int) (((double) getItemBurnTime(this.slots[2]) / FurnaceVariables.STEEL_FURNACE_T2_EFFICIENCY));
			...
			if (this.isBurning() && this.canSmelt1()) {
				...
				if (this.cookTime1 == FurnaceVariables.STEEL_FURNACE_T2_SPEED) {
					this.cookTime1 = 0;
					this.smeltItem1();
					flag1 = true;
				}
			...
			if (this.isBurning() && this.canSmelt2()) {
				...
				if (this.cookTime2 == FurnaceVariables.STEEL_FURNACE_T2_SPEED) {
					this.cookTime2 = 0;
					this.smeltItem2();
					flag1 = true;
				}
			...
			if (flag != this.isBurning()) {
				flag1 = true;
				SteelFurnaceT2.updateSteelFurnaceT2State(this.burnTime > 0,
