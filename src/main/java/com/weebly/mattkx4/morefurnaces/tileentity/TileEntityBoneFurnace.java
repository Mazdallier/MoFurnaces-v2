...
import com.weebly.mattkx4.morefurnaces.blocks.BoneFurnace;
...
public class TileEntityBoneFurnace extends TileEntity implements
		ISidedInventory {
	...
	public void updateEntity() {
		...
		if (!this.worldObj.isRemote) {
			...
			if (flag != this.isBurning()) {
				flag1 = true;
				BoneFurnace.updateBoneFurnaceState(this.burnTime > 0,
	...
	public static int getItemBurnTime(ItemStack itemstack) {
		if (itemstack == null) {
			...
			if (item == Items.bone)
				return 1600;
			if (item == new ItemStack(Items.dye, 15).getItem())
				return 533;
		}
