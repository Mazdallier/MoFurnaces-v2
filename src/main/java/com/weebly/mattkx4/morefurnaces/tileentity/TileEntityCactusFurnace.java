...
import com.weebly.mattkx4.morefurnaces.blocks.CactusFurnace;
...
public class TileEntityCactusFurnace extends TileEntity implements
		ISidedInventory {
	...
	public void updateEntity() {
		...
		if (!this.worldObj.isRemote) {
			...
			if (flag != this.isBurning()) {
				flag1 = true;
				CactusFurnace.updateCactusFurnaceState(this.burnTime > 0,
