...
import com.weebly.mattkx4.morefurnaces.blocks.DiamondFurnace;
...
public class TileEntityDiamondFurnace extends TileEntity implements
		ISidedInventory {
	...
	public int getCookProgressScaled(int i) {
		return this.cookTime * i / FurnaceVariables.DIAMOND_FURNACE_SPEED;
	}
	...
	public int getBurnTimeRemainingScaled(int i) {
		...
		if (this.currentItemBurnTime == 0) {
			this.currentItemBurnTime = FurnaceVariables.DIAMOND_FURNACE_SPEED;
		}
	...
	public void updateEntity() {
		...
		if (!this.worldObj.isRemote) {
			...
			if (this.burnTime == 0 && this.canSmelt()) {
				...
				// lasting furnace
				this.currentItemBurnTime = this.burnTime = (int) (((double) getItemBurnTime(this.slots[1]) / FurnaceVariables.DIAMOND_FURNACE_EFFICIENCY) + 0.5);
			...
			if (this.isBurning() && this.canSmelt()) {
				...
				if (this.cookTime == FurnaceVariables.DIAMOND_FURNACE_SPEED) {
					this.cookTime = 0;
					this.smeltItem();
					flag1 = true;
				}
			...
			if (flag != this.isBurning()) {
				flag1 = true;
				DiamondFurnace.updateDiamondFurnaceState(this.burnTime > 0,
