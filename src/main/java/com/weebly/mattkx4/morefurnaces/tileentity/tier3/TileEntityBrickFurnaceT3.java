...
import com.weebly.mattkx4.morefurnaces.blocks.tier3.BrickFurnaceT3;
...
public class TileEntityBrickFurnaceT3 extends TileEntity implements
		ISidedInventory {
	...
	public int getCookProgressScaled1(int i) {
		return this.cookTime1 * i / FurnaceVariables.BRICK_FURNACE_T3_SPEED;
	}

	// Gets the cooking progress (Scaled) for item 2
	@SideOnly(Side.CLIENT)
	public int getCookProgressScaled2(int i) {
		return this.cookTime2 * i / FurnaceVariables.BRICK_FURNACE_T3_SPEED;
	}

	// Gets the cooking progress (Scaled) for item 3
	@SideOnly(Side.CLIENT)
	public int getCookProgressScaled3(int i) {
		return this.cookTime3 * i / FurnaceVariables.BRICK_FURNACE_T3_SPEED;
	}
	...
	public int getBurnTimeRemainingScaled(int i) {
		...
		if (this.currentItemBurnTime == 0) {
			this.currentItemBurnTime = FurnaceVariables.BRICK_FURNACE_T3_SPEED;
		}
	...
	public void updateEntity() {
		...
		if (!this.worldObj.isRemote) {
			...
			if (this.burnTime == 0
				...
				// lasting furnace
				this.currentItemBurnTime = this.burnTime = (int) (((double) getItemBurnTime(this.slots[3]) / FurnaceVariables.BRICK_FURNACE_T3_EFFICIENCY) - 0.4D);
			...
			if (this.isBurning() && this.canSmelt1()) {
				...
				if (this.cookTime1 == FurnaceVariables.BRICK_FURNACE_T3_SPEED) {
					this.cookTime1 = 0;
					this.smeltItem1();
					flag1 = true;
				}
			...
			if (this.isBurning() && this.canSmelt2()) {
				...
				if (this.cookTime2 == FurnaceVariables.BRICK_FURNACE_T3_SPEED) {
					this.cookTime2 = 0;
					this.smeltItem2();
					flag1 = true;
				}
			...
			if (this.isBurning() && this.canSmelt3()) {
				...
				if (this.cookTime3 == FurnaceVariables.BRICK_FURNACE_T3_SPEED) {
					this.cookTime3 = 0;
					this.smeltItem3();
					flag1 = true;
				}
			...
			if (flag != this.isBurning()) {
				flag1 = true;
				BrickFurnaceT3.updateBrickFurnaceT3State(this.burnTime > 0,
