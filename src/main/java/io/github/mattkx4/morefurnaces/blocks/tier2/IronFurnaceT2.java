...
public class IronFurnaceT2 extends BlockContainer{
	...
	public void registerBlockIcons(IIconRegister iconRegister){
		...
		this.iconFront = iconRegister.registerIcon(Strings.MODID+":"+(this.isActive ? "IronFurnaceT2_front_active" : "IronFurnaceT2_front_idle"));
		...
		// Tiers the Brick Furnace to Tier 3
				if(player.getCurrentEquippedItem() != null) {
					if(player.getCurrentEquippedItem().getItem() == MFMItems.Tier3Device) {
						...
						IronFurnaceT3.updateIronFurnaceT3State(isActive, world, x, y, z);
						
						TileEntityIronFurnaceT3 tileentityT3 = (TileEntityIronFurnaceT3)world.getTileEntity(x, y, z);
