...
public class QuartzFurnaceT2 extends BlockContainer{
		...
		// Tiers the Brick Furnace to Tier 3
				if(player.getCurrentEquippedItem() != null) {
					if(player.getCurrentEquippedItem().getItem() == MFMItems.Tier3Device) {
						...
						QuartzFurnaceT3.updateQuartzFurnaceT3State(isActive, world, x, y, z);
	...
	public static void updateQuartzFurnaceT2State(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) {
		...
		if(active == true){
			worldObj.setBlock(xCoord, yCoord, zCoord, MFMT2Blocks.QuartzFurnaceT2Active);
		}else{
			worldObj.setBlock(xCoord, yCoord, zCoord, MFMT2Blocks.QuartzFurnaceT2Idle);
		}
		keepInventory = false;
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityplayer, ItemStack itemstack){
		...
		if(itemstack.hasDisplayName()){
			((TileEntityQuartzFurnaceT2)world.getTileEntity(x, y, z)).setGuiDisplayName(itemstack.getDisplayName());
		}
	}
