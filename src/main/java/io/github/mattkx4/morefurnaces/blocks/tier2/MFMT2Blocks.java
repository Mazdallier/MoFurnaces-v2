...
public class MFMT2Blocks {
	...
	public static void initializeBlock() {
		...
		BrickFurnaceT2Idle = new BrickFurnaceT2(false).setBlockName("BrickFurnaceT2Idle").setHardness(2.0F).setResistance(10.0F).setStepSound(MFMBlocks.soundTypeBrick).setCreativeTab(MoFurnacesMod.TieredMFM);
		BrickFurnaceT2Active = new BrickFurnaceT2(true).setBlockName("BrickFurnaceT2Active").setHardness(2.0F).setResistance(10.0F).setStepSound(MFMBlocks.soundTypeBrick).setLightLevel(0.625F);
		...
		DiamondFurnaceT2Active = new DiamondFurnaceT2(true).setBlockName("DiamondFurnaceT2Active").setHardness(5.0F).setResistance(10.0F).setStepSound(MFMBlocks.soundTypeDiamond).setLightLevel(0.625F);
		
		// Initialize the Tier 2 Obsidian Furnace
		ObsidianFurnaceT2Idle = new ObsidianFurnaceT2(false).setBlockName("ObsidianFurnaceT2Idle").setHardness(50.0F).setResistance(2000.0F).setStepSound(MFMBlocks.soundTypeObsidian).setCreativeTab(MoFurnacesMod.TieredMFM);
		ObsidianFurnaceT2Active = new ObsidianFurnaceT2(true).setBlockName("ObsidianFurnaceT2Active").setHardness(50.0F).setResistance(2000.0F).setStepSound(MFMBlocks.soundTypeObsidian).setLightLevel(0.625F);	
	}
