...
public class ObsidianFurnaceT2 extends BlockContainer{
	...
	public void registerBlockIcons(IIconRegister iconRegister){
		this.blockIcon = iconRegister.registerIcon(Strings.MODID+":ObsidianFurnaceT2_side");
		...
		this.iconTop = iconRegister.registerIcon(Strings.MODID+":ObsidianFurnaceT2_top");
	}
