...
public class BoneFurnace extends BlockContainer{
	...
	public BoneFurnace(boolean isActive) {
		super(Material.rock);
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitx, float hity, float hitz){
		if(!world.isRemote) {
			FMLNetworkHandler.openGui(player, MoFurnacesMod.instance, MoFurnacesMod.guiIDBoneFurnace, world, x, y, z);
		}
		return true;
	}

	public static void updateBoneFurnaceState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) {
	...
	public TileEntity createNewTileEntity(World world, int i) {
		return new TileEntityBoneFurnace();
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityplayer, ItemStack itemstack){
		...
		if(itemstack.hasDisplayName()){
			((TileEntityBoneFurnace)world.getTileEntity(x, y, z)).setGuiDisplayName(itemstack.getDisplayName());
		}
	}
	...
	public void breakBlock(World world, int x, int y, int z, Block oldblock, int oldmetadata){
        if (!keepInventory){
            TileEntityBoneFurnace tileentity = (TileEntityBoneFurnace)world.getTileEntity(x, y, z);
