...
public class DiamondFurnaceT2 extends BlockContainer{
	...
	public Item getItemDropped(int i, Random random, int j){
		return Item.getItemFromBlock(MFMT2Blocks.DiamondFurnaceT2Idle);	
	}	
	...
	public void registerBlockIcons(IIconRegister iconRegister){
		...
		this.iconFront = iconRegister.registerIcon(Strings.MODID+":"+(this.isActive ? "DiamondFurnaceT2_front_active" : "DiamondFurnaceT2_front_idle")); // Fix textures
		...
		// Tiers the Brick Furnace to Tier 3
				if(player.getCurrentEquippedItem() != null) {
					if(player.getCurrentEquippedItem().getItem() == MFMItems.Tier3Device) {
						...
						ItemStack fuel;
						ItemStack product1;
						ItemStack product2;//create variable for the fuel burn and item cook times
						int burnTime = 0;
						int cookTime1 = 0;
						int cookTime2 = 0;
						...
						world.setBlock(x, y, z, MFMT3Blocks.DiamondFurnaceT3Idle);
						world.setBlockMetadataWithNotify(x, y, z, i, 2);
						//sets whether or not the new furnace is active of inactive
						DiamondFurnaceT3.updateDiamondFurnaceT3State(isActive, world, x, y, z);
						
						TileEntityDiamondFurnaceT3 tileentityT3 = (TileEntityDiamondFurnaceT3)world.getTileEntity(x, y, z);
	...
	public static void updateDiamondFurnaceT2State(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) {
		...
		if(active == true){
			worldObj.setBlock(xCoord, yCoord, zCoord, MFMT2Blocks.DiamondFurnaceT2Active);
		}else{
			worldObj.setBlock(xCoord, yCoord, zCoord, MFMT2Blocks.DiamondFurnaceT2Idle);
		}
		keepInventory = false;
