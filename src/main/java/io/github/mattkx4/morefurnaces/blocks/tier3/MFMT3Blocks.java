...
public class MFMT3Blocks {
	...
	public static void initializeBlock(){
		...
		BrickFurnaceT3Idle = new BrickFurnaceT3(false).setBlockName("BrickFurnaceT3Idle").setHardness(2.0F).setResistance(10.0F).setStepSound(MFMBlocks.soundTypeBrick).setCreativeTab(MoFurnacesMod.TieredMFM);
		BrickFurnaceT3Active = new BrickFurnaceT3(true).setBlockName("BrickFurnaceT3Active").setHardness(2.0F).setResistance(10.0F).setStepSound(MFMBlocks.soundTypeBrick).setLightLevel(0.625F);
		...
		ObsidianFurnaceT3Idle = new ObsidianFurnaceT3(false).setBlockName("ObsidianFurnaceT3Idle").setHardness(50.0F).setResistance(2000.0F).setStepSound(MFMBlocks.soundTypeObsidian).setCreativeTab(MoFurnacesMod.TieredMFM);
		ObsidianFurnaceT3Active = new ObsidianFurnaceT3(true).setBlockName("ObsidianFurnaceT3Active").setHardness(50.0F).setResistance(2000.0F).setStepSound(MFMBlocks.soundTypeObsidian).setLightLevel(0.625F);
	}
