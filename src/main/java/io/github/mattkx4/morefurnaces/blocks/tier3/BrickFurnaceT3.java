...
public class BrickFurnaceT3 extends BlockContainer {
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		...
		this.iconFront = iconRegister.registerIcon(Strings.MODID
				+ ":"
				+ (this.isActive ? "BrickFurnaceT3_front_active"
						: "BrickFurnaceT3_front_idle"));
	...
	public boolean onBlockActivated(World world, int x, int y, int z,
		...
		if (!world.isRemote) {
			FMLNetworkHandler.openGui(player, MoFurnacesMod.instance,
					MoFurnacesMod.guiIDBrickFurnaceT3, world, x, y, z);
		}
		return true;
	}

	public static void updateBrickFurnaceT3State(boolean active,
		...
		if (active == true) {
			worldObj.setBlock(xCoord, yCoord, zCoord,
					MFMT3Blocks.BrickFurnaceT3Active);
		} else {
			worldObj.setBlock(xCoord, yCoord, zCoord,
					MFMT3Blocks.BrickFurnaceT3Idle);
		}
		keepInventory = false;
	...
	public void onBlockPlacedBy(World world, int x, int y, int z,
		...
		if (itemstack.hasDisplayName()) {
			((TileEntityBrickFurnaceT3) world.getTileEntity(x, y, z))
	...
	public void breakBlock(World world, int x, int y, int z, Block oldblock,
			int oldmetadata) {
		if (!keepInventory) {
			TileEntityBrickFurnaceT3 tileentity = (TileEntityBrickFurnaceT3) world
					.getTileEntity(x, y, z);
