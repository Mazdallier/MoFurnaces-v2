...
public class BrickFurnaceT3 extends BlockContainer{
	/*
	...
	public BrickFurnaceT3(boolean isActive) {
		super(Material.rock);
	...
	public void registerBlockIcons(IIconRegister iconRegister){
		...
		this.iconFront = iconRegister.registerIcon(Strings.MODID+":"+(this.isActive ? "BrickFurnaceT3_front_active" : "BrickFurnaceT3_front_idle"));
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitx, float hity, float hitz){
		if(!world.isRemote) {
			FMLNetworkHandler.openGui(player, MoFurnacesMod.instance, MoFurnacesMod.guiIDBrickFurnaceT3, world, x, y, z);
		}
		return true;
	}

	public static void updateBrickFurnaceT3State(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) {
	...
	public TileEntity createNewTileEntity(World world, int i) {
		return new TileEntityBrickFurnaceT3();
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityplayer, ItemStack itemstack){
		...
		if(itemstack.hasDisplayName()){
			((TileEntityBrickFurnaceT3)world.getTileEntity(x, y, z)).setGuiDisplayName(itemstack.getDisplayName());
		}
	}
	...
	public void breakBlock(World world, int x, int y, int z, Block oldblock, int oldmetadata){
        if (!keepInventory){
            TileEntityBrickFurnaceT3 tileentity = (TileEntityBrickFurnaceT3)world.getTileEntity(x, y, z);
