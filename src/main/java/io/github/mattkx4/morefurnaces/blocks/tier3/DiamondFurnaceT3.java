...
import io.github.mattkx4.morefurnaces.particles.EntityDiamondFlameFX;
...
public class DiamondFurnaceT3 extends BlockContainer{
	/*
	...
	public DiamondFurnaceT3(boolean isActive) {
		super(Material.rock);
	...
	public Item getItemDropped(int i, Random random, int j){
		return Item.getItemFromBlock(MFMT3Blocks.DiamondFurnaceT3Idle);	
	}	
	...
	public void registerBlockIcons(IIconRegister iconRegister){
		...
		this.iconFront = iconRegister.registerIcon(Strings.MODID+":"+(this.isActive ? "DiamondFurnaceT3_front_active" : "DiamondFurnaceT3_front_idle"));
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitx, float hity, float hitz){
		if(!world.isRemote) {
			FMLNetworkHandler.openGui(player, MoFurnacesMod.instance, MoFurnacesMod.guiIDDiamondFurnaceT3, world, x, y, z);
		}
		return true;
	}

	public static void updateDiamondFurnaceT3State(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) {
		...
		if(active == true){
			worldObj.setBlock(xCoord, yCoord, zCoord, MFMT3Blocks.DiamondFurnaceT3Active);
		}else{
			worldObj.setBlock(xCoord, yCoord, zCoord, MFMT3Blocks.DiamondFurnaceT3Idle);
		}
		keepInventory = false;
	...
	public TileEntity createNewTileEntity(World world, int i) {
		return new TileEntityDiamondFurnaceT3();
	}
	...
	public void breakBlock(World world, int x, int y, int z, Block oldblock, int oldmetadata){
        if (!keepInventory){
            TileEntityDiamondFurnaceT3 tileentity = (TileEntityDiamondFurnaceT3)world.getTileEntity(x, y, z);
    ...
    public void randomDisplayTick(World world, int x, int y, int z, Random random){ 	
        ...
        if (this.isActive){
            ...
            if(direction == 4){
				...
				Minecraft.getMinecraft().effectRenderer.addEffect(new EntityDiamondFlameFX(world, (double)(x1 - f), (double)y1, (double)(z1 + f1), 0.0D, 0.0D, 0.0D));
            	...
            	Minecraft.getMinecraft().effectRenderer.addEffect(new EntityDiamondFlameFX(world, (double)(x1 + f1), (double)y1, (double)(z1 - f), 0.0D, 0.0D, 0.0D));  
        	}else if (direction == 3){
            	world.spawnParticle("smoke", (double)(x1 + f1), (double)y1, (double)(z1 + f), 0.0D, 0.0D, 0.0D);
            	Minecraft.getMinecraft().effectRenderer.addEffect(new EntityDiamondFlameFX(world, (double)(x1 + f1), (double)y1, (double)(z1 + f), 0.0D, 0.0D, 0.0D));       
        	}
