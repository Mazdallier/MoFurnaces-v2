...
public class BrickFurnaceT2 extends BlockContainer {
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		...
		this.iconFront = iconRegister.registerIcon(Strings.MODID
				+ ":"
				+ (this.isActive ? "BrickFurnaceT2_front_active"
						: "BrickFurnaceT2_front_idle")); // Fix textures
	...
	public boolean onBlockActivated(World world, int x, int y, int z,
		...
		if (player.getCurrentEquippedItem() != null) {
			if (player.getCurrentEquippedItem().getItem() == MFMItems.Tier3Device) {
				...
				TileEntityBrickFurnaceT2 tileentity = (TileEntityBrickFurnaceT2) world
						.getTileEntity(x, y, z);
				...
				BrickFurnaceT3.updateBrickFurnaceT3State(isActive, world, x, y,
						z);

				// set the tile entity itemstacks and variable times
				TileEntityBrickFurnaceT3 tileentityT3 = (TileEntityBrickFurnaceT3) world
						.getTileEntity(x, y, z);
				if (input1 != null) {
		...
		if (!world.isRemote) {
			FMLNetworkHandler.openGui(player, MoFurnacesMod.instance,
					MoFurnacesMod.guiIDBrickFurnaceT2, world, x, y, z);
		}
		return true;
	}

	public static void updateBrickFurnaceT2State(boolean active,
		...
		if (active == true) {
			worldObj.setBlock(xCoord, yCoord, zCoord,
					MFMT2Blocks.BrickFurnaceT2Active);
		} else {
			worldObj.setBlock(xCoord, yCoord, zCoord,
					MFMT2Blocks.BrickFurnaceT2Idle);
		}
		keepInventory = false;
	...
	public void onBlockPlacedBy(World world, int x, int y, int z,
		...
		if (itemstack.hasDisplayName()) {
			((TileEntityBrickFurnaceT2) world.getTileEntity(x, y, z))
		...
		if (this.isActive) {
			...
			if (direction == 4) {
				...
				Minecraft.getMinecraft().effectRenderer
						.addEffect(new EntityBrickFlameFX(world,
