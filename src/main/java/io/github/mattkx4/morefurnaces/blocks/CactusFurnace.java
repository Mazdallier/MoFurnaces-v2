...
public class CactusFurnace extends BlockContainer implements IPlantable {
	...
	public void registerBlockIcons(IIconRegister iconRegister){
		this.blockIcon = iconRegister.registerIcon(Strings.MODID+":CactusFurnace_side");
		this.iconFront = iconRegister.registerIcon(Strings.MODID+":"+(this.isActive ? "CactusFurnace_front_active" : "CactusFurnace_front_idle"));
		this.iconTop = iconRegister.registerIcon(Strings.MODID+":CactusFurnace_top");
	}
	...
	public static void updateCactusFurnaceState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) {
		...
		if(active == true){
			worldObj.setBlock(xCoord, yCoord, zCoord, MFMBlocks.CactusFurnaceActive);
		}else{
			worldObj.setBlock(xCoord, yCoord, zCoord, MFMBlocks.CactusFurnaceIdle);
		}
		keepInventory = false;
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityplayer, ItemStack itemstack){
		...
		if(itemstack.hasDisplayName()){
			((TileEntityCactusFurnace)world.getTileEntity(x, y, z)).setGuiDisplayName(itemstack.getDisplayName());
		}
	...
	public void breakBlock(World world, int x, int y, int z, Block oldblock, int oldmetadata){
        if (!keepInventory){
            TileEntityCactusFurnace tileentity = (TileEntityCactusFurnace)world.getTileEntity(x, y, z);
    ...
    public void randomDisplayTick(World world, int x, int y, int z, Random random){ 	
        ...
        if (this.isActive){
            ...
            if(direction == 4){
				...
				Minecraft.getMinecraft().effectRenderer.addEffect(new EntityCactusFlameFX(world, (double)(x1 - f), (double)y1, (double)(z1 + f1), 0.0D, 0.0D, 0.0D));
            	...
            	Minecraft.getMinecraft().effectRenderer.addEffect(new EntityCactusFlameFX(world, (double)(x1 + f1), (double)y1, (double)(z1 - f), 0.0D, 0.0D, 0.0D));  
        	}else if (direction == 3){
            	world.spawnParticle("smoke", (double)(x1 + f1), (double)y1, (double)(z1 + f), 0.0D, 0.0D, 0.0D);
            	Minecraft.getMinecraft().effectRenderer.addEffect(new EntityCactusFlameFX(world, (double)(x1 + f1), (double)y1, (double)(z1 + f), 0.0D, 0.0D, 0.0D));       
        	}
