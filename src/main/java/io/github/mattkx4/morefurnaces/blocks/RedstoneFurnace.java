...
public class RedstoneFurnace extends BlockContainer {
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		this.blockIcon = iconRegister.registerIcon(Strings.MODID
				+ ":RedstoneFurnace_side");
		this.iconFront = iconRegister.registerIcon(Strings.MODID
				+ ":"
				+ (this.isActive ? "RedstoneFurnace_front_active"
						: "RedstoneFurnace_front_idle"));
	...
	public boolean onBlockActivated(World world, int x, int y, int z,
		...
		if (!world.isRemote) {
			FMLNetworkHandler.openGui(player, MoFurnacesMod.instance,
					MoFurnacesMod.guiIDRedstoneFurnace, world, x, y, z);
		}
		return true;
	}

	public static void updateRedstoneFurnaceState(boolean active,
		...
		if (active == true) {
			worldObj.setBlock(xCoord, yCoord, zCoord,
					MFMBlocks.RedstoneFurnaceActive);
		} else {
			worldObj.setBlock(xCoord, yCoord, zCoord,
					MFMBlocks.RedstoneFurnaceIdle);
		}
		keepInventory = false;
	...
	public void onBlockPlacedBy(World world, int x, int y, int z,
		...
		if (itemstack.hasDisplayName()) {
			((TileEntityRedstoneFurnace) world.getTileEntity(x, y, z))
	...
	public void breakBlock(World world, int x, int y, int z, Block oldblock,
			int oldmetadata) {
		if (!keepInventory) {
			TileEntityRedstoneFurnace tileentity = (TileEntityRedstoneFurnace) world
					.getTileEntity(x, y, z);
	...
	// extra function utilized ONLY by the hopper aspects of the redstone
	// furnace
