...
public class RedstoneFurnace extends BlockContainer{
	...
	public RedstoneFurnace(boolean isActive) {
		super(Material.iron);
	...
	public void registerBlockIcons(IIconRegister iconRegister){
		this.blockIcon = iconRegister.registerIcon(Strings.MODID+":RedstoneFurnace_side");
		this.iconFront = iconRegister.registerIcon(Strings.MODID+":"+(this.isActive ? "RedstoneFurnace_front_active" : "RedstoneFurnace_front_idle"));
		this.iconTop = iconRegister.registerIcon(Strings.MODID+":RedstoneFurnace_top");
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitx, float hity, float hitz){
		if(!world.isRemote) {
			FMLNetworkHandler.openGui(player, MoFurnacesMod.instance, MoFurnacesMod.guiIDRedstoneFurnace, world, x, y, z);
		}
		return true;
	}

	public static void updateRedstoneFurnaceState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) {
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityplayer, ItemStack itemstack){
		...
		if(itemstack.hasDisplayName()){
			((TileEntityRedstoneFurnace)world.getTileEntity(x, y, z)).setGuiDisplayName(itemstack.getDisplayName());
		}
	}
	...
	public void breakBlock(World world, int x, int y, int z, Block oldblock, int oldmetadata){
        if (!keepInventory){
            TileEntityRedstoneFurnace tileentity = (TileEntityRedstoneFurnace)world.getTileEntity(x, y, z);
    ...
    public void randomDisplayTick(World world, int x, int y, int z, Random random){ 	
        ...
        if (this.isActive){
            ...
            if(direction == 4){
				...
				Minecraft.getMinecraft().effectRenderer.addEffect(new EntityRedstoneFlameFX(world, (double)(x1 - f), (double)y1, (double)(z1 + f1), 0.0D, 0.0D, 0.0D));
            	...
            	Minecraft.getMinecraft().effectRenderer.addEffect(new EntityRedstoneFlameFX(world, (double)(x1 + f1), (double)y1, (double)(z1 - f), 0.0D, 0.0D, 0.0D));  
        	}else if (direction == 3){
            	world.spawnParticle("smoke", (double)(x1 + f1), (double)y1, (double)(z1 + f), 0.0D, 0.0D, 0.0D);
            	Minecraft.getMinecraft().effectRenderer.addEffect(new EntityRedstoneFlameFX(world, (double)(x1 + f1), (double)y1, (double)(z1 + f), 0.0D, 0.0D, 0.0D));       
        	}
