...
public class IronFurnaceT3 extends BlockContainer{
	...
	public Item getItemDropped(int i, Random random, int j){
		return Item.getItemFromBlock(MFMBlock.IronFurnaceT3Idle);	
	}	
	...
	public static void updateIronFurnaceT3State(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) {
		...
		if(active == true){
			worldObj.setBlock(xCoord, yCoord, zCoord, MFMBlock.IronFurnaceT3Active);
		}else{
			worldObj.setBlock(xCoord, yCoord, zCoord, MFMBlock.IronFurnaceT3Idle);
		}
		keepInventory = false;
