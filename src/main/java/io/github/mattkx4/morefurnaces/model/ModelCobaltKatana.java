...
public class ModelCobaltKatana extends ModelBiped{
	//fields
	ModelRenderer head;
	ModelRenderer body;
    ...
    public ModelCobaltKatana(){
	    ...
	    emeraldfurnace = new ModelRenderer(this, 40, 0);
	    ...
	    strapback2 = new ModelRenderer(this, 32, 0);
	    ...
	    strapback1 = new ModelRenderer(this, 32, 0);
	    ...
	    strapfront1 = new ModelRenderer(this, 36, 0);
	    ...
	    strapfront2 = new ModelRenderer(this, 36, 0);
	    ...
	    strapfronthorizontal = new ModelRenderer(this, 32, 12);
