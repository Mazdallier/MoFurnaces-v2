...
public class ContainerBrickFurnaceT3 extends Container{
	private TileEntityBrickFurnaceT3 brickFurnaceT3;
	 ...
	 */
	public ContainerBrickFurnaceT3(InventoryPlayer inventory, TileEntityBrickFurnaceT3 tileentity) {
		this.brickFurnaceT3 = tileentity;
	...
	public void addCraftingToCrafters (ICrafting icrafting) {
		...
		icrafting.sendProgressBarUpdate(this, 0, this.brickFurnaceT3.cookTime1);
		icrafting.sendProgressBarUpdate(this, 1, this.brickFurnaceT3.cookTime2);
		icrafting.sendProgressBarUpdate(this, 2, this.brickFurnaceT3.cookTime3);
		icrafting.sendProgressBarUpdate(this, 3, this.brickFurnaceT3.burnTime);
		icrafting.sendProgressBarUpdate(this, 4, this.brickFurnaceT3.currentItemBurnTime);
	}
	...
	public void detectAndSendChanges() {
		...
		for(int i = 0; i < this.crafters.size(); i++) {
			...
			if(this.lastCookTime1 != this.brickFurnaceT3.cookTime1) {
				icrafting.sendProgressBarUpdate(this, 0, this.brickFurnaceT3.cookTime1);
			}
			
			if(this.lastCookTime2 != this.brickFurnaceT3.cookTime2) {
				icrafting.sendProgressBarUpdate(this, 1, this.brickFurnaceT3.cookTime2);
			}
			
			if(this.lastCookTime3 != this.brickFurnaceT3.cookTime3) {
				icrafting.sendProgressBarUpdate(this, 2, this.brickFurnaceT3.cookTime3);
			}

			if(this.lastBurnTime != this.brickFurnaceT3.burnTime) {
				icrafting.sendProgressBarUpdate(this, 3, this.brickFurnaceT3.burnTime);
			}

			if(this.lastCurrentItemBurnTime != this.brickFurnaceT3.currentItemBurnTime) {
				icrafting.sendProgressBarUpdate(this, 4, this.brickFurnaceT3.currentItemBurnTime);
			}
		}

		this.lastCookTime1 = this.brickFurnaceT3.cookTime1;
		this.lastCookTime2 = this.brickFurnaceT3.cookTime2;
		this.lastCookTime3 = this.brickFurnaceT3.cookTime3;
		this.lastBurnTime = this.brickFurnaceT3.burnTime;
		this.lastCurrentItemBurnTime = this.brickFurnaceT3.currentItemBurnTime;
	}
    ...
    {
        if (par1 == 0) {
            this.brickFurnaceT3.cookTime1 = par2;
        }
        
        if (par1 == 1) {
        	this.brickFurnaceT3.cookTime2 = par2;
        }
        
        if (par1 == 2) {
        	this.brickFurnaceT3.cookTime3 = par2;
        }

        if (par1 == 3) {
            this.brickFurnaceT3.burnTime = par2;
        }

        if (par1 == 4) {
            this.brickFurnaceT3.currentItemBurnTime = par2;
        }
    }
