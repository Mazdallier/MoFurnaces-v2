...
public class ContainerPumpkinFurnace extends Container{
	 ...
	 */
	public ContainerPumpkinFurnace(InventoryPlayer inventory, TileEntityPumpkinFurnace tileentity) {
	...
	public void addCraftingToCrafters (ICrafting icrafting) {
		...
		icrafting.sendProgressBarUpdate(this, 2, this.pumpkinFurnace.currentItemBurnTime);
	}
