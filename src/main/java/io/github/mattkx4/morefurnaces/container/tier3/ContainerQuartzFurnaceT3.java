...
public class ContainerQuartzFurnaceT3 extends Container{
	private TileEntityQuartzFurnaceT3 quartzFurnaceT3;
	 ...
	 */
	public ContainerQuartzFurnaceT3(InventoryPlayer inventory, TileEntityQuartzFurnaceT3 tileentity) {
		this.quartzFurnaceT3 = tileentity;
	...
	public void addCraftingToCrafters (ICrafting icrafting) {
		...
		icrafting.sendProgressBarUpdate(this, 0, this.quartzFurnaceT3.cookTime1);
		icrafting.sendProgressBarUpdate(this, 1, this.quartzFurnaceT3.cookTime2);
		icrafting.sendProgressBarUpdate(this, 2, this.quartzFurnaceT3.cookTime3);
		icrafting.sendProgressBarUpdate(this, 3, this.quartzFurnaceT3.burnTime);
		icrafting.sendProgressBarUpdate(this, 4, this.quartzFurnaceT3.currentItemBurnTime);
	}
	...
	public void detectAndSendChanges() {
		...
		for(int i = 0; i < this.crafters.size(); i++) {
			...
			if(this.lastCookTime1 != this.quartzFurnaceT3.cookTime1) {
				icrafting.sendProgressBarUpdate(this, 0, this.quartzFurnaceT3.cookTime1);
			}
			
			if(this.lastCookTime2 != this.quartzFurnaceT3.cookTime2) {
				icrafting.sendProgressBarUpdate(this, 1, this.quartzFurnaceT3.cookTime2);
			}
			
			if(this.lastCookTime3 != this.quartzFurnaceT3.cookTime3) {
				icrafting.sendProgressBarUpdate(this, 2, this.quartzFurnaceT3.cookTime3);
			}

			if(this.lastBurnTime != this.quartzFurnaceT3.burnTime) {
				icrafting.sendProgressBarUpdate(this, 3, this.quartzFurnaceT3.burnTime);
			}

			if(this.lastCurrentItemBurnTime != this.quartzFurnaceT3.currentItemBurnTime) {
				icrafting.sendProgressBarUpdate(this, 4, this.quartzFurnaceT3.currentItemBurnTime);
			}
		}

		this.lastCookTime1 = this.quartzFurnaceT3.cookTime1;
		this.lastCookTime2 = this.quartzFurnaceT3.cookTime2;
		this.lastCookTime3 = this.quartzFurnaceT3.cookTime3;
		this.lastBurnTime = this.quartzFurnaceT3.burnTime;
		this.lastCurrentItemBurnTime = this.quartzFurnaceT3.currentItemBurnTime;
	}
    ...
    {
        if (par1 == 0) {
            this.quartzFurnaceT3.cookTime1 = par2;
        }
        
        if (par1 == 1) {
        	this.quartzFurnaceT3.cookTime2 = par2;
        }
        
        if (par1 == 2) {
        	this.quartzFurnaceT3.cookTime3 = par2;
        }

        if (par1 == 3) {
            this.quartzFurnaceT3.burnTime = par2;
        }

        if (par1 == 4) {
            this.quartzFurnaceT3.currentItemBurnTime = par2;
        }
    }
        ...
        if (slot != null && slot.getHasStack()) {
             ...
             */ 
                ...
                if (FurnaceRecipes.smelting().getSmeltingResult(itemstack1) != null) {
                	/*
                	 * This is where it gets tricky, but basically the code tries to merge the right clicked item with 
                	 * the input slots (slot 0 or 1). If the item in the input slots matches the item in the right 
                	 * clicked slot then the stack is moved across. if the input slot is empty then the item is moved across.
                	 * 
                ...
                }else if (TileEntityQuartzFurnaceT3.isItemFuel(itemstack1)) {
                ...
                }else if (slots >= 34 && slots < 43 && !this.mergeItemStack(itemstack1, 7, 34, false)) {
                    return null;
                }
