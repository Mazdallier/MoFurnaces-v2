...
public class ContainerBrickFurnaceT2 extends Container{
	
	private TileEntityBrickFurnaceT2 brickFurnaceT2;
	 ...
	 */
	public ContainerBrickFurnaceT2(InventoryPlayer inventory, TileEntityBrickFurnaceT2 tileentity) {
		this.brickFurnaceT2 = tileentity;
	...
	public void addCraftingToCrafters (ICrafting icrafting) {
		...
		icrafting.sendProgressBarUpdate(this, 0, this.brickFurnaceT2.cookTime1);
		icrafting.sendProgressBarUpdate(this, 3, this.brickFurnaceT2.cookTime2);
		icrafting.sendProgressBarUpdate(this, 1, this.brickFurnaceT2.burnTime);
		icrafting.sendProgressBarUpdate(this, 2, this.brickFurnaceT2.currentItemBurnTime);
	}
	...
	public void detectAndSendChanges() {
		...
		for(int i = 0; i < this.crafters.size(); i++) {
			...
			if(this.lastCookTime1 != this.brickFurnaceT2.cookTime1) {
				icrafting.sendProgressBarUpdate(this, 0, this.brickFurnaceT2.cookTime1);
			}
			
			if(this.lastCookTime2 != this.brickFurnaceT2.cookTime2) {
				icrafting.sendProgressBarUpdate(this, 3, this.brickFurnaceT2.cookTime2);
			}

			if(this.lastBurnTime != this.brickFurnaceT2.burnTime) {
				icrafting.sendProgressBarUpdate(this, 1, this.brickFurnaceT2.burnTime);
			}

			if(this.lastCurrentItemBurnTime != this.brickFurnaceT2.currentItemBurnTime) {
				icrafting.sendProgressBarUpdate(this, 2, this.brickFurnaceT2.currentItemBurnTime);
			}
		}

		this.lastCookTime1 = this.brickFurnaceT2.cookTime1;
		this.lastCookTime2 = this.brickFurnaceT2.cookTime2;
		this.lastBurnTime = this.brickFurnaceT2.burnTime;
		this.lastCurrentItemBurnTime = this.brickFurnaceT2.currentItemBurnTime;
	}
    ...
    {
        if (par1 == 0) {
            this.brickFurnaceT2.cookTime1 = par2;
        }
        
        if (par1 == 3) {
        	this.brickFurnaceT2.cookTime2 = par2;
        }

        if (par1 == 1) {
            this.brickFurnaceT2.burnTime = par2;
        }

        if (par1 == 2) {
            this.brickFurnaceT2.currentItemBurnTime = par2;
        }
    }
