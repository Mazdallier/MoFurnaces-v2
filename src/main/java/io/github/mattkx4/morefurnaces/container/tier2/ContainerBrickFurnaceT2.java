...
public class ContainerBrickFurnaceT2 extends Container {
	 ...
	 */
	public ContainerBrickFurnaceT2(InventoryPlayer inventory,
			TileEntityBrickFurnaceT2 tileentity) {
	...
	public void addCraftingToCrafters(ICrafting icrafting) {
		...
		icrafting.sendProgressBarUpdate(this, 2,
				this.brickFurnaceT2.currentItemBurnTime);
	}
