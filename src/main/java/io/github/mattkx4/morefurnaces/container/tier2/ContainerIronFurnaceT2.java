...
public class ContainerIronFurnaceT2 extends Container{
	
	private TileEntityIronFurnaceT2 ironFurnaceT2;
	 ...
	 */
	public ContainerIronFurnaceT2(InventoryPlayer inventory, TileEntityIronFurnaceT2 tileentity) {
		this.ironFurnaceT2 = tileentity;
	...
	public void addCraftingToCrafters (ICrafting icrafting) {
		...
		icrafting.sendProgressBarUpdate(this, 0, this.ironFurnaceT2.cookTime1);
		icrafting.sendProgressBarUpdate(this, 3, this.ironFurnaceT2.cookTime2);
		icrafting.sendProgressBarUpdate(this, 1, this.ironFurnaceT2.burnTime);
		icrafting.sendProgressBarUpdate(this, 2, this.ironFurnaceT2.currentItemBurnTime);
	}
	...
	public void detectAndSendChanges() {
		...
		for(int i = 0; i < this.crafters.size(); i++) {
			...
			if(this.lastCookTime1 != this.ironFurnaceT2.cookTime1) {
				icrafting.sendProgressBarUpdate(this, 0, this.ironFurnaceT2.cookTime1);
			}
			
			if(this.lastCookTime2 != this.ironFurnaceT2.cookTime2) {
				icrafting.sendProgressBarUpdate(this, 3, this.ironFurnaceT2.cookTime2);
			}

			if(this.lastBurnTime != this.ironFurnaceT2.burnTime) {
				icrafting.sendProgressBarUpdate(this, 1, this.ironFurnaceT2.burnTime);
			}

			if(this.lastCurrentItemBurnTime != this.ironFurnaceT2.currentItemBurnTime) {
				icrafting.sendProgressBarUpdate(this, 2, this.ironFurnaceT2.currentItemBurnTime);
			}
		}

		this.lastCookTime1 = this.ironFurnaceT2.cookTime1;
		this.lastCookTime2 = this.ironFurnaceT2.cookTime2;
		this.lastBurnTime = this.ironFurnaceT2.burnTime;
		this.lastCurrentItemBurnTime = this.ironFurnaceT2.currentItemBurnTime;
	}
    ...
    {
        if (par1 == 0) {
            this.ironFurnaceT2.cookTime1 = par2;
        }
        
        if (par1 == 3) {
        	this.ironFurnaceT2.cookTime2 = par2;
        }

        if (par1 == 1) {
            this.ironFurnaceT2.burnTime = par2;
        }

        if (par1 == 2) {
            this.ironFurnaceT2.currentItemBurnTime = par2;
        }
    }
