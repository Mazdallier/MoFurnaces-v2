...
public class ContainerIronFurnaceT2 extends Container {
	 ...
	 */
	public ContainerIronFurnaceT2(InventoryPlayer inventory,
			TileEntityIronFurnaceT2 tileentity) {
	...
	public void addCraftingToCrafters(ICrafting icrafting) {
		...
		icrafting.sendProgressBarUpdate(this, 2,
				this.ironFurnaceT2.currentItemBurnTime);
	}
