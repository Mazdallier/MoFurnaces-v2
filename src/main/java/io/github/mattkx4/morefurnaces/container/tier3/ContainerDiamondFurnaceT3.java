...
public class ContainerDiamondFurnaceT3 extends Container{
	private TileEntityDiamondFurnaceT3 diamondFurnaceT3;
	 ...
	 */
	public ContainerDiamondFurnaceT3(InventoryPlayer inventory, TileEntityDiamondFurnaceT3 tileentity) {
		this.diamondFurnaceT3 = tileentity;
	...
	public void addCraftingToCrafters (ICrafting icrafting) {
		...
		icrafting.sendProgressBarUpdate(this, 0, this.diamondFurnaceT3.cookTime1);
		icrafting.sendProgressBarUpdate(this, 1, this.diamondFurnaceT3.cookTime2);
		icrafting.sendProgressBarUpdate(this, 2, this.diamondFurnaceT3.cookTime3);
		icrafting.sendProgressBarUpdate(this, 3, this.diamondFurnaceT3.burnTime);
		icrafting.sendProgressBarUpdate(this, 4, this.diamondFurnaceT3.currentItemBurnTime);
	}
	...
	public void detectAndSendChanges() {
		...
		for(int i = 0; i < this.crafters.size(); i++) {
			...
			if(this.lastCookTime1 != this.diamondFurnaceT3.cookTime1) {
				icrafting.sendProgressBarUpdate(this, 0, this.diamondFurnaceT3.cookTime1);
			}
			
			if(this.lastCookTime2 != this.diamondFurnaceT3.cookTime2) {
				icrafting.sendProgressBarUpdate(this, 1, this.diamondFurnaceT3.cookTime2);
			}
			
			if(this.lastCookTime3 != this.diamondFurnaceT3.cookTime3) {
				icrafting.sendProgressBarUpdate(this, 2, this.diamondFurnaceT3.cookTime3);
			}

			if(this.lastBurnTime != this.diamondFurnaceT3.burnTime) {
				icrafting.sendProgressBarUpdate(this, 3, this.diamondFurnaceT3.burnTime);
			}

			if(this.lastCurrentItemBurnTime != this.diamondFurnaceT3.currentItemBurnTime) {
				icrafting.sendProgressBarUpdate(this, 4, this.diamondFurnaceT3.currentItemBurnTime);
			}
		}

		this.lastCookTime1 = this.diamondFurnaceT3.cookTime1;
		this.lastCookTime2 = this.diamondFurnaceT3.cookTime2;
		this.lastCookTime3 = this.diamondFurnaceT3.cookTime3;
		this.lastBurnTime = this.diamondFurnaceT3.burnTime;
		this.lastCurrentItemBurnTime = this.diamondFurnaceT3.currentItemBurnTime;
	}
    ...
    {
        if (par1 == 0) {
            this.diamondFurnaceT3.cookTime1 = par2;
        }
        
        if (par1 == 1) {
        	this.diamondFurnaceT3.cookTime2 = par2;
        }
        
        if (par1 == 2) {
        	this.diamondFurnaceT3.cookTime3 = par2;
        }

        if (par1 == 3) {
            this.diamondFurnaceT3.burnTime = par2;
        }

        if (par1 == 4) {
            this.diamondFurnaceT3.currentItemBurnTime = par2;
        }
    }
