...
public class ContainerQuartzFurnaceT2 extends Container{
	
	private TileEntityQuartzFurnaceT2 quartzFurnaceT2;
	 ...
	 */
	public ContainerQuartzFurnaceT2(InventoryPlayer inventory, TileEntityQuartzFurnaceT2 tileentity) {
		this.quartzFurnaceT2 = tileentity;

		/**
		 * - Slot is a new input/output slot
		 * 		- slots 0 and 1 are inputs for items,
		 * 		- slot 2 is the fuel input
		 * - SlotFurnace is a new furnace output slot
		 * 		- slots 3 and 4 are outputs for cooked items
		...
		this.addSlotToContainer(new SlotFurnace(inventory.player, tileentity, 3, 116, 22));
	...
	public void addCraftingToCrafters (ICrafting icrafting) {
		...
		icrafting.sendProgressBarUpdate(this, 0, this.quartzFurnaceT2.cookTime1);
		icrafting.sendProgressBarUpdate(this, 3, this.quartzFurnaceT2.cookTime2);
		icrafting.sendProgressBarUpdate(this, 1, this.quartzFurnaceT2.burnTime);
		icrafting.sendProgressBarUpdate(this, 2, this.quartzFurnaceT2.currentItemBurnTime);
	}
	...
	public void detectAndSendChanges() {
		...
		for(int i = 0; i < this.crafters.size(); i++) {
			...
			if(this.lastCookTime1 != this.quartzFurnaceT2.cookTime1) {
				icrafting.sendProgressBarUpdate(this, 0, this.quartzFurnaceT2.cookTime1);
			}
			
			if(this.lastCookTime2 != this.quartzFurnaceT2.cookTime2) {
				icrafting.sendProgressBarUpdate(this, 3, this.quartzFurnaceT2.cookTime2);
			}

			if(this.lastBurnTime != this.quartzFurnaceT2.burnTime) {
				icrafting.sendProgressBarUpdate(this, 1, this.quartzFurnaceT2.burnTime);
			}

			if(this.lastCurrentItemBurnTime != this.quartzFurnaceT2.currentItemBurnTime) {
				icrafting.sendProgressBarUpdate(this, 2, this.quartzFurnaceT2.currentItemBurnTime);
			}
		}

		this.lastCookTime1 = this.quartzFurnaceT2.cookTime1;
		this.lastCookTime2 = this.quartzFurnaceT2.cookTime2;
		this.lastBurnTime = this.quartzFurnaceT2.burnTime;
		this.lastCurrentItemBurnTime = this.quartzFurnaceT2.currentItemBurnTime;
	}
    ...
    {
        if (par1 == 0) {
            this.quartzFurnaceT2.cookTime1 = par2;
        }
        
        if (par1 == 3) {
        	this.quartzFurnaceT2.cookTime2 = par2;
        }

        if (par1 == 1) {
            this.quartzFurnaceT2.burnTime = par2;
        }

        if (par1 == 2) {
            this.quartzFurnaceT2.currentItemBurnTime = par2;
        }
    }
	...
	public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int slots)
    {
        ...
        if (slot != null && slot.getHasStack()) {
             ...
             */ 
                ...
                }else if (TileEntityQuartzFurnaceT2.isItemFuel(itemstack1)) {
                ...
                }else if (slots >= 32 && slots < 41 && !this.mergeItemStack(itemstack1, 5, 32, false)) {
                    return null;
                }
