...
public static final ResourceLocation bground = new ResourceLocation(Strings.MODID + ":textures/gui/brick_furnace.png");
	
	public TileEntityBrickFurnace brickFurnace;
	
	public GuiBrickFurnace(InventoryPlayer inventoryPlayer, TileEntityBrickFurnace entity) {
	...
	public void drawGuiContainerForegroundLayer(int i, int j){
		...
		String name = this.brickFurnace.hasCustomInventoryName() ? this.brickFurnace.getInventoryName() : I18n.format(this.brickFurnace.getInventoryName(), new Object[0]);
