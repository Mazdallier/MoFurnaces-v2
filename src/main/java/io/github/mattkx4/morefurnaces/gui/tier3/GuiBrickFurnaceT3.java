...
public class GuiBrickFurnaceT3 extends GuiContainer {
	...
	public GuiBrickFurnaceT3(InventoryPlayer inventoryPlayer,
	...
	public void drawGuiContainerForegroundLayer(int i, int j) {
		...
		String name = this.brickFurnaceT3.hasCustomInventoryName() ? this.brickFurnaceT3
				.getInventoryName() : I18n.format(
				this.brickFurnaceT3.getInventoryName(), new Object[0]);
