...
public static final ResourceLocation bground = new ResourceLocation(Strings.MODID + ":textures/gui/custom_furnace_tier3.png");
	...
	public GuiQuartzFurnaceT3(InventoryPlayer inventoryPlayer, TileEntityQuartzFurnaceT3 entity) {
	...
	public void drawGuiContainerForegroundLayer(int i, int j){
		...
		String name = this.quartzFurnaceT3.hasCustomInventoryName() ? this.quartzFurnaceT3.getInventoryName() : I18n.format(this.quartzFurnaceT3.getInventoryName(), new Object[0]);
