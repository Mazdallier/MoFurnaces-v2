...
public static final ResourceLocation bground = new ResourceLocation(Strings.MODID + ":textures/gui/iron_furnace_tier3.png");
	
	public TileEntityIronFurnaceT3 ironFurnaceT3;
	
	public GuiIronFurnaceT3(InventoryPlayer inventoryPlayer, TileEntityIronFurnaceT3 entity) {
	...
	public void drawGuiContainerForegroundLayer(int i, int j){
		...
		String name = this.ironFurnaceT3.hasCustomInventoryName() ? this.ironFurnaceT3.getInventoryName() : I18n.format(this.ironFurnaceT3.getInventoryName(), new Object[0]);
