...
public static final ResourceLocation bground = new ResourceLocation(Strings.MODID + ":textures/gui/diamond_furnace_tier3.png");
	
	public TileEntityDiamondFurnaceT3 diamondFurnaceT3;
	
	public GuiDiamondFurnaceT3(InventoryPlayer inventoryPlayer, TileEntityDiamondFurnaceT3 entity) {
	...
	public void drawGuiContainerForegroundLayer(int i, int j){
		...
		String name = this.diamondFurnaceT3.hasCustomInventoryName() ? this.diamondFurnaceT3.getInventoryName() : I18n.format(this.diamondFurnaceT3.getInventoryName(), new Object[0]);
