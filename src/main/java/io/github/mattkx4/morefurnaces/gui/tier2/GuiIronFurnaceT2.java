...
public class GuiIronFurnaceT2 extends GuiContainer{
public static final ResourceLocation bground = new ResourceLocation(Strings.MODID + ":textures/gui/iron_furnace_tier2.png");
	
	public TileEntityIronFurnaceT2 ironFurnaceT2;
	
	public GuiIronFurnaceT2(InventoryPlayer inventoryPlayer, TileEntityIronFurnaceT2 entity) {
		super(new ContainerIronFurnaceT2(inventoryPlayer, entity));

		this.ironFurnaceT2 = entity;
	...
	public void drawGuiContainerForegroundLayer(int i, int j){
		...
		String name = this.ironFurnaceT2.hasCustomInventoryName() ? this.ironFurnaceT2.getInventoryName() : I18n.format(this.ironFurnaceT2.getInventoryName(), new Object[0]);
	...
	protected void drawGuiContainerBackgroundLayer(float i, int j, int k) {
		...
		if(this.ironFurnaceT2.isBurning()){
			int m = this.ironFurnaceT2.getBurnTimeRemainingScaled(14);
			int l = 14 - m;
