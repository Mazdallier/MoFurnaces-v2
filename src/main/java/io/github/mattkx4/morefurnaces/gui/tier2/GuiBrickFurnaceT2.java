...
public class GuiBrickFurnaceT2 extends GuiContainer {
	...
	public GuiBrickFurnaceT2(InventoryPlayer inventoryPlayer,
	...
	public void drawGuiContainerForegroundLayer(int i, int j) {
		...
		String name = this.brickFurnaceT2.hasCustomInventoryName() ? this.brickFurnaceT2
				.getInventoryName() : I18n.format(
				this.brickFurnaceT2.getInventoryName(), new Object[0]);
	...
	protected void drawGuiContainerBackgroundLayer(float i, int j, int k) {
		...
		if (this.brickFurnaceT2.isBurning()) {
			...
			int l = 14 - m;
			drawTexturedModalRect(guiLeft + 38, guiTop + 36 + l, 176, 17 + l,
					14, 14 - l);
		}
