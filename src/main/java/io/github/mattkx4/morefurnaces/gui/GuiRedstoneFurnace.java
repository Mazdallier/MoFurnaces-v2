...
public class GuiRedstoneFurnace extends GuiContainer {
	...
	public static final ResourceLocation bground = new ResourceLocation(
			Strings.MODID + ":textures/gui/redstone_furnace.png");

	public TileEntityRedstoneFurnace redstoneFurnace;

	public GuiRedstoneFurnace(InventoryPlayer inventoryPlayer,
	...
	public void drawGuiContainerForegroundLayer(int i, int j) {
		...
		String name = this.redstoneFurnace.hasCustomInventoryName() ? this.redstoneFurnace
				.getInventoryName() : I18n.format(
				this.redstoneFurnace.getInventoryName(), new Object[0]);
