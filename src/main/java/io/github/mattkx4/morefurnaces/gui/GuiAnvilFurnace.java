...
public static final ResourceLocation bground = new ResourceLocation(Strings.MODID + ":textures/gui/anvil_furnace.png");
	
	public TileEntityAnvilFurnace anvilFurnace;
	
	public GuiAnvilFurnace(InventoryPlayer inventoryPlayer, TileEntityAnvilFurnace entity) {
	...
	public void drawGuiContainerForegroundLayer(int i, int j){
		...
		String name = this.anvilFurnace.hasCustomInventoryName() ? this.anvilFurnace.getInventoryName() : I18n.format(this.anvilFurnace.getInventoryName(), new Object[0]);
	...
	protected void drawGuiContainerBackgroundLayer(float i, int j, int k) {
		...
		if(this.anvilFurnace.isBurning()){
			...
			int l = 14 - m;
			drawTexturedModalRect(guiLeft + 81, guiTop + 45 + l, 176, 0 + l, 14, 14 - l);
		}
		
		// Draws the progress bar for the current item being cooked (Arrow)
		int n = this.anvilFurnace.getCookProgressScaled(18);
		int o = 18 - n;
		drawTexturedModalRect(guiLeft + 104, guiTop + 20 + o, 176, 14 + o, 6, 18 - o);
