...
public class GuiObsidianFurnace extends GuiContainer {
	...
	public GuiObsidianFurnace(InventoryPlayer inventoryPlayer,
	...
	public void drawGuiContainerForegroundLayer(int i, int j) {
		...
		String name = this.obsidianFurnace.hasCustomInventoryName() ? this.obsidianFurnace
				.getInventoryName() : I18n.format(
				this.obsidianFurnace.getInventoryName(), new Object[0]);
	...
	protected void drawGuiContainerBackgroundLayer(float i, int j, int k) {
		...
		if (this.obsidianFurnace.isBurning()) {
			...
			int l = 14 - m;
			drawTexturedModalRect(guiLeft + 57, guiTop + 36 + l, 176, 87 + l,
					14, 14 - l);
		}
