...
public class GuiDiamondFurnaceT2 extends GuiContainer {
	...
	public GuiDiamondFurnaceT2(InventoryPlayer inventoryPlayer,
	...
	public void drawGuiContainerForegroundLayer(int i, int j) {
		...
		String name = this.diamondFurnaceT2.hasCustomInventoryName() ? this.diamondFurnaceT2
				.getInventoryName() : I18n.format(
				this.diamondFurnaceT2.getInventoryName(), new Object[0]);
