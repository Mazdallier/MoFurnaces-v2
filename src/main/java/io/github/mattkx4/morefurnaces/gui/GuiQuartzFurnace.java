...
public class GuiQuartzFurnace extends GuiContainer {
	...
	public GuiQuartzFurnace(InventoryPlayer inventoryPlayer,
	...
	public void drawGuiContainerForegroundLayer(int i, int j) {
		...
		String name = this.quartzFurnace.hasCustomInventoryName() ? this.quartzFurnace
				.getInventoryName() : I18n.format(
				this.quartzFurnace.getInventoryName(), new Object[0]);
	...
	protected void drawGuiContainerBackgroundLayer(float i, int j, int k) {
		...
		if (this.quartzFurnace.isBurning()) {
			...
			int l = 14 - m;
			drawTexturedModalRect(guiLeft + 57, guiTop + 36 + l, 176, 101 + l,
					14, 14 - l);
		}
