...
import io.github.mattkx4.morefurnaces.blocks.ObsidianFurnaceT3;
...
public class TileEntityObsidianFurnaceT3 extends TileEntity implements ISidedInventory{
private String localizedName;
	...
	public String getInventoryName(){
		return this.hasCustomInventoryName() ? this.localizedName : "container.obsidianFurnaceT3";
	}
	...
	public void updateEntity(){
		...
		if(!this.worldObj.isRemote) {
			...
			if(flag != this.isBurning()) {
				flag1 = true;
				ObsidianFurnaceT3.updateObsidianFurnaceT3State(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
			}
		}
