...
public class TileEntityIronFurnaceT2 extends TileEntity implements ISidedInventory{
...
private String localizedName;
	...
	public String getInventoryName(){
		return this.hasCustomInventoryName() ? this.localizedName : "container.ironFurnaceT2";
	}
	...
	public void updateEntity(){
		...
		if(!this.worldObj.isRemote) {
			...
			if(flag != this.isBurning()) {
				flag1 = true;
				IronFurnaceT2.updateIronFurnaceT2State(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
			}
		}
