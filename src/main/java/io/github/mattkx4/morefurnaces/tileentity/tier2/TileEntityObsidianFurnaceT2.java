...
public class TileEntityObsidianFurnaceT2 extends TileEntity implements ISidedInventory{
...
private String localizedName;
	...
	public String getInventoryName(){
		return this.hasCustomInventoryName() ? this.localizedName : "container.obsidianFurnaceT2";
	}
	...
	public int getCookProgressScaled1(int i){
		return this.cookTime1 * i / FurnaceVariables.OBSIDIAN_FURNACE_T2_SPEED;
	}
	
    // Gets the cooking progress (Scaled) for item 2
	@SideOnly(Side.CLIENT)
	public int getCookProgressScaled2(int i){
		return this.cookTime2 * i / FurnaceVariables.OBSIDIAN_FURNACE_T2_SPEED;
	}
	...
	// Get the remaining burn time (Scaled)
		...
		public int getBurnTimeRemainingScaled(int i){
			...
			if(this.currentItemBurnTime == 0){
				this.currentItemBurnTime = FurnaceVariables.OBSIDIAN_FURNACE_T2_SPEED;
			}
	...
	public void updateEntity(){
		...
		if(!this.worldObj.isRemote) {
			...
			if((this.burnTime == 0 && this.canSmelt1()) || (this.burnTime == 0 && this.canSmelt2())) {
				...
				this.currentItemBurnTime = this.burnTime = (int) (((double)getItemBurnTime(this.slots[2]) / FurnaceVariables.OBSIDIAN_FURNACE_T2_EFFICIENCY) + 0.5);
			...
			if(this.isBurning() && this.canSmelt1()) {
				...
				if(this.cookTime1 == FurnaceVariables.OBSIDIAN_FURNACE_T2_SPEED) {
					this.cookTime1 = 0;
					this.smeltItem1();
					flag1 = true;
				}
			...
			if(this.isBurning() && this.canSmelt2()) {
				...
				if(this.cookTime2 == FurnaceVariables.OBSIDIAN_FURNACE_T2_SPEED) {
					this.cookTime2 = 0;
					this.smeltItem2();
					flag1 = true;
				}
			...
			if(flag != this.isBurning()) {
				flag1 = true;
				ObsidianFurnaceT2.updateObsidianFurnaceT2State(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
			}
		}
