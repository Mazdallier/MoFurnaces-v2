...
public class TileEntityIronFurnaceT3 extends TileEntity implements ISidedInventory{
private String localizedName;
	...
	public String getInventoryName(){
		return this.hasCustomInventoryName() ? this.localizedName : "container.ironFurnaceT3";
	}
	...
	public int getCookProgressScaled1(int i){
		return this.cookTime1 * i / FurnaceVariables.IRON_FURNACE_T3_SPEED;
	}
	
    // Gets the cooking progress (Scaled) for item 2
	@SideOnly(Side.CLIENT)
	public int getCookProgressScaled2(int i){
		return this.cookTime2 * i / FurnaceVariables.IRON_FURNACE_T3_SPEED;
	}
	
    // Gets the cooking progress (Scaled) for item 3
	@SideOnly(Side.CLIENT)
	public int getCookProgressScaled3(int i){
		return this.cookTime3 * i / FurnaceVariables.IRON_FURNACE_T3_SPEED;
	}
	...
	// Get the remaining burn time (Scaled)
		...
		public int getBurnTimeRemainingScaled(int i){
			...
			if(this.currentItemBurnTime == 0){
				this.currentItemBurnTime = FurnaceVariables.IRON_FURNACE_T3_SPEED;
			}
	...
	public void updateEntity(){
		...
		if(!this.worldObj.isRemote) {
			...
			if(this.burnTime == 0 && (this.canSmelt1() || this.canSmelt2() || this.canSmelt3())) {
				...
				this.currentItemBurnTime = this.burnTime = (int) (((double)getItemBurnTime(this.slots[3]) / FurnaceVariables.IRON_FURNACE_T3_EFFICIENCY));
			...
			if(this.isBurning() && this.canSmelt1()) {
				...
				if(this.cookTime1 == FurnaceVariables.IRON_FURNACE_T3_SPEED) {
					this.cookTime1 = 0;
					this.smeltItem1();
					flag1 = true;
				}
			...
			if(this.isBurning() && this.canSmelt2()) {
				...
				if(this.cookTime2 == FurnaceVariables.IRON_FURNACE_T3_SPEED) {
					this.cookTime2 = 0;
					this.smeltItem2();
					flag1 = true;
				}
			...
			if(this.isBurning() && this.canSmelt3()) {
				...
				if(this.cookTime3 == FurnaceVariables.IRON_FURNACE_T3_SPEED) {
					this.cookTime3 = 0;
					this.smeltItem3();
					flag1 = true;
				}
			...
			if(flag != this.isBurning()) {
				flag1 = true;
				IronFurnaceT3.updateIronFurnaceT3State(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
			}
		}
