...
public class TileEntityBoneFurnace extends TileEntity implements ISidedInventory{
	...
	public String getInventoryName(){
		return this.hasCustomInventoryName() ? this.localizedName : "container.boneFurnace";
	}
	...
	public int getCookProgressScaled(int i){
		return this.cookTime * i / FurnaceVariables.BONE_FURNACE_SPEED;
	}
	...
	// Get the remaining burn time (Scaled)
		...
		public int getBurnTimeRemainingScaled(int i){
			...
			if(this.currentItemBurnTime == 0){
				this.currentItemBurnTime = FurnaceVariables.BONE_FURNACE_SPEED;
			}
	...
	public void updateEntity(){
		...
		if(!this.worldObj.isRemote) {
			...
			if(this.burnTime == 0 && this.canSmelt()) {
				...
				this.currentItemBurnTime = this.burnTime = (int) (((double)getItemBurnTime(this.slots[1]) / FurnaceVariables.BONE_FURNACE_EFFICIENCY));
			...
			if(this.cookTime == FurnaceVariables.BONE_FURNACE_SPEED) {
				this.cookTime = 0;
				this.smeltItem();
				flag1 = true;
				}
			...
			if(flag != this.isBurning()) {
				flag1 = true;
				BoneFurnace.updateBoneFurnaceState(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
			}
		}
