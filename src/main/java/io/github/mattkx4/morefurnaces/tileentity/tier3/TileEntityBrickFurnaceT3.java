...
public class TileEntityBrickFurnaceT3 extends TileEntity implements ISidedInventory{
private String localizedName;
	...
	public String getInventoryName(){
		return this.hasCustomInventoryName() ? this.localizedName : "container.brickFurnaceT3";
	}
	...
	public void updateEntity(){
		...
		if(!this.worldObj.isRemote) {
			...
			if(flag != this.isBurning()) {
				flag1 = true;
				BrickFurnaceT3.updateBrickFurnaceT3State(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
			}
		}
