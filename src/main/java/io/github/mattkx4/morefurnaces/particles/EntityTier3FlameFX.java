...
public class EntityTier3FlameFX extends EntityFX{

public static final ResourceLocation flame = new ResourceLocation(Strings.MODID + ":textures/particles/tier3_flame.png");
